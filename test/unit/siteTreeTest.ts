...
describe("Site Tree", function() {
    ...
    describe("in multiple sites", function() {
        it("doesn't crach with multiple sites", function() {
            const parent : MenuEntry = MenuEntry.parse(new Site('http://toto.com/'), {ID: 1, menu_item_parent: 0, title: "Some_Page parent 1",rest_url: "/wp-json/bla?bla", ...bogusWpMenu}),
                child : MenuEntry = MenuEntry.parse(new Site('http://toto.com/'), {ID: 2, menu_item_parent: 1, title: "Some_Page child 2",rest_url: "/wp-json/bla?bla", ...bogusWpMenu});
            const parent2 : MenuEntry = MenuEntry.parse(new Site('http://tototata.com/'), {ID: 1, menu_item_parent: 0, title: "Some_Page parent 1 bis",rest_url: "/wp-json/bla?bla", ...bogusWpMenu}),
        ...
        it("gets external site reference", function() {
            const parent : MenuEntry = MenuEntry.parse(new Site('http://tototata.com/'), {ID: 1, menu_item_parent: 0, title: "Some_Page parent 1",rest_url: "/wp-json/bla?bla", ...bogusWpMenu}),
                child : MenuEntry = MenuEntry.parse(new Site('http://tototata.com/'), {ID: 2, menu_item_parent: 1, title: "Some_Page child 2",rest_url: "/wp-json/bla?bla", ...bogusWpMenu}),
                parent2 : MenuEntry = MenuEntry.parse(new Site('http://tototata.com/'), {ID: 1, menu_item_parent: 0, title: "Some_Page parent 1 bis",rest_url: "/wp-json/bla?bla", ...bogusWpMenu}),
                child2 : MenuEntry = MenuEntry.parse(new Site('http://tototata.com/'), {ID: 3, menu_item_parent: 1 ,title: "Some_Page child 3",rest_url: "/wp-json/bla?bla", ...bogusWpMenu}),
